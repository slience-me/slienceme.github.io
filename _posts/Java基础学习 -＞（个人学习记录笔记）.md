...
idea常用快捷键
![在这里插入图片描述](https://img-blog.csdnimg.cn/20210109064244117.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NsaWVuY2VfbWU=,size_16,color_FFFFFF,t_70)
...
```
![在这里插入图片描述](https://img-blog.csdnimg.cn/20210108072903704.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NsaWVuY2VfbWU=,size_16,color_FFFFFF,t_70)
# 第三章 变量和数据类型
## 3.1 变量概述
...
```
![在这里插入图片描述](https://img-blog.csdnimg.cn/20210108100316683.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NsaWVuY2VfbWU=,size_16,color_FFFFFF,t_70)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20210108102109119.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NsaWVuY2VfbWU=,size_16,color_FFFFFF,t_70)
# 第四章 数据类型转换
## 4.1 自动转换
...
# 第五章 运算符
## 5.1 算数运算符
![在这里插入图片描述](https://img-blog.csdnimg.cn/20210108165435380.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NsaWVuY2VfbWU=,size_16,color_FFFFFF,t_70)
...
```
![在这里插入图片描述](https://img-blog.csdnimg.cn/20210109070001877.png)
## 6.2 方法的定义格式与三种调用格式
```java
...
## 10.5 内存划分
### 内存主要划分5个部分
![在这里插入图片描述](https://img-blog.csdnimg.cn/20210109120547863.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NsaWVuY2VfbWU=,size_16,color_FFFFFF,t_70)
### 只有一个数组的内存图
![在这里插入图片描述](https://img-blog.csdnimg.cn/20210109120857456.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NsaWVuY2VfbWU=,size_16,color_FFFFFF,t_70)
...
### 有两个数组的内存图
![在这里插入图片描述](https://img-blog.csdnimg.cn/2021010912143062.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NsaWVuY2VfbWU=,size_16,color_FFFFFF,t_70)
...
```
### 两个引用指向同一个数组的内存图
![在这里插入图片描述](https://img-blog.csdnimg.cn/20210109121818413.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NsaWVuY2VfbWU=,size_16,color_FFFFFF,t_70)
...
```
![在这里插入图片描述](https://img-blog.csdnimg.cn/20210109123040728.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NsaWVuY2VfbWU=,size_16,color_FFFFFF,t_70)
...
```
![在这里插入图片描述](https://img-blog.csdnimg.cn/20210109123554157.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NsaWVuY2VfbWU=,size_16,color_FFFFFF,t_70)
...
```
![在这里插入图片描述](https://img-blog.csdnimg.cn/20210109124234397.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NsaWVuY2VfbWU=,size_16,color_FFFFFF,t_70)
