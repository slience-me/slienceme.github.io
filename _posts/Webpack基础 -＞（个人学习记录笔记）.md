...
![在这里插入图片描述](https://img-blog.csdnimg.cn/a2d4ae5c957e4d97baaaecaa962a67dc.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NsaWVuY2VfbWU=,size_16,color_FFFFFF,t_70)
## 2. webpack的安装
管理员模式运行cmd
```
npm i -g webpack
npm i -g webpack-cli
```
![在这里插入图片描述](https://img-blog.csdnimg.cn/346031446cd34d96a9832bfd9777a1ff.png)

## 3. webpack的起步
- 打包 入口文件 -o 保存路径
- `webpack ./src/main.js -o ./dist/bundle.js`

![在这里插入图片描述](https://img-blog.csdnimg.cn/86722f0202244d998c998e525db3438b.png)
配置打包文件开发模式、生产模式
```js
module.exports={
  // mode: 'production',
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/a58cf92d242a49d7ae794737bc0bea43.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NsaWVuY2VfbWU=,size_16,color_FFFFFF,t_70)
### 5.1 css文件的处理
...
2. 在`webpack.config.js`中的`modules`关键字下进行配置
	...
	`publicPath:'dist/'`防止找不到，`index.html`与不在`dict`文件夹时
						![在这里插入图片描述](https://img-blog.csdnimg.cn/e1241d4847304c73b15ed358640ad1f6.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/d6e93db159464a21b2564b5fb64539d9.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NsaWVuY2VfbWU=,size_16,color_FFFFFF,t_70)
## 7. plugin的使用
...
```
![在这里插入图片描述](https://img-blog.csdnimg.cn/09deb530079c492fafc7b6f33d7f93a9.png)
### 7.2 打包html的Plugin 
作用：
