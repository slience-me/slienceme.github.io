...
```
![在这里插入图片描述](https://img-blog.csdnimg.cn/20201130190733293.png)
## 2.2 引用的注意事项
**1、引用必须初始化
	int &b; //错误的
2、一旦初始化后，就不可以更改了**
...
```
![在这里插入图片描述](https://img-blog.csdnimg.cn/20201130191422869.png)
## 2.3 引用做函数参数
...
```
![在这里插入图片描述](https://img-blog.csdnimg.cn/20201130194158312.png)
## 2.5 引用的本质
...
```
![在这里插入图片描述](https://img-blog.csdnimg.cn/20201130195004595.png)
...
**继承是面向对象三大特性之一**
有些类与类之间存在特殊的关系，例图如下：
![在这里插入图片描述](https://img-blog.csdnimg.cn/20201214104302494.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NsaWVuY2VfbWU=,size_16,color_FFFFFF,t_70)
利用继承，减少重复代码
...
**4.6.2 继承方式**
![在这里插入图片描述](https://img-blog.csdnimg.cn/20201214115839411.png)
**继承方式一共有三种：**

 - 公共继承
 - 保护继承
 - 私有继承
![在这里插入图片描述](https://img-blog.csdnimg.cn/20201214120033913.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NsaWVuY2VfbWU=,size_16,color_FFFFFF,t_70)
...
C++允许一个类继承多个类
![在这里插入图片描述](https://img-blog.csdnimg.cn/2020121414215130.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20201214143934475.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NsaWVuY2VfbWU=,size_16,color_FFFFFF,t_70)
![在这里插入图片描述](https://img-blog.csdnimg.cn/20201214143720483.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20201214155637890.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NsaWVuY2VfbWU=,size_16,color_FFFFFF,t_70)
重写前：
![在这里插入图片描述](https://img-blog.csdnimg.cn/20201214155906298.png)
重写后：
![在这里插入图片描述](https://img-blog.csdnimg.cn/20201214155922429.png)
![在这里插入图片描述](https://img-blog.csdnimg.cn/20201214160023523.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NsaWVuY2VfbWU=,size_16,color_FFFFFF,t_70)
...
因此可以将虚函数改为**纯虚函数**
![纯虚函数语法：](https://img-blog.csdnimg.cn/20201214163236314.png)
...
```
**4.7.4 多态案例二-制作饮品**
![在这里插入图片描述](https://img-blog.csdnimg.cn/20201214164613224.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NsaWVuY2VfbWU=,size_16,color_FFFFFF,t_70)
...
虚析构和纯虚析构区别：
 ...
 ![在这里插入图片描述](https://img-blog.csdnimg.cn/20201214170640187.png)
...
```
**文件打开方式：**
![在这里插入图片描述](https://img-blog.csdnimg.cn/20201212213912543.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NsaWVuY2VfbWU=,size_16,color_FFFFFF,t_70)
...
函数原型：![在这里插入图片描述](https://img-blog.csdnimg.cn/20201214185752558.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20201214191224907.png)
参数解释：字符指针buffer指向内存中一段存储空间。len是读写的字节数
