...
# 第一章 常用API
## 1. API概述和使用
![在这里插入图片描述](https://img-blog.csdnimg.cn/20210110092345411.png)
![在这里插入图片描述](https://img-blog.csdnimg.cn/20210110092430469.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NsaWVuY2VfbWU=,size_16,color_FFFFFF,t_70)
## 2. Scanner概述及其API文档
### 2.1 什么是Scanner类
...
```
### 5.2 什么是ArrayList类
![在这里插入图片描述](https://img-blog.csdnimg.cn/20210110192728486.png)

### 5.3 ArrayList使用步骤
![在这里插入图片描述](https://img-blog.csdnimg.cn/20210110192805482.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NsaWVuY2VfbWU=,size_16,color_FFFFFF,t_70)
...
```
![在这里插入图片描述](https://img-blog.csdnimg.cn/20210120115615535.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NsaWVuY2VfbWU=,size_16,color_FFFFFF,t_70)
### 6.3 字符串的比较相关方法
...
```
## 7. static静态
![在这里插入图片描述](https://img-blog.csdnimg.cn/20210122194205581.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NsaWVuY2VfbWU=,size_16,color_FFFFFF,t_70)
### 7.1 静态static关键字修饰成员
...
```
### 7.3 静态static的内存图
![在这里插入图片描述](https://img-blog.csdnimg.cn/20210122200903419.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NsaWVuY2VfbWU=,size_16,color_FFFFFF,t_70)
...
# 第二章 继承与多态
## 1. 继承
![在这里插入图片描述](https://img-blog.csdnimg.cn/20210123100119502.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NsaWVuY2VfbWU=,size_16,color_FFFFFF,t_70)
### 1.1 继承的格式
...
```
![在这里插入图片描述](https://img-blog.csdnimg.cn/20210123104754321.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NsaWVuY2VfbWU=,size_16,color_FFFFFF,t_70)
### 1.6 继承中方法的覆盖重写（应用）
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20210123110420656.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NsaWVuY2VfbWU=,size_16,color_FFFFFF,t_70)
...
```
### 1.11 Java继承的三个特点
![在这里插入图片描述](https://img-blog.csdnimg.cn/20210123111157184.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NsaWVuY2VfbWU=,size_16,color_FFFFFF,t_70)

## 2. 抽象类
### 2.1 抽象的概念
![在这里插入图片描述](https://img-blog.csdnimg.cn/20210123111424750.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NsaWVuY2VfbWU=,size_16,color_FFFFFF,t_70)
### 2.2 抽象方法和抽象类的格式
...
```
### 2.4 抽象方法和抽象类的注意事项
![在这里插入图片描述](https://img-blog.csdnimg.cn/20210123112230337.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NsaWVuY2VfbWU=,size_16,color_FFFFFF,t_70)
...
```
### 2.5 发红包案例
![在这里插入图片描述](https://img-blog.csdnimg.cn/20210123112917500.png)
![在这里插入图片描述](https://img-blog.csdnimg.cn/20210123113355201.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NsaWVuY2VfbWU=,size_16,color_FFFFFF,t_70)
...
## 3. 接口
![在这里插入图片描述](https://img-blog.csdnimg.cn/2021012311465837.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NsaWVuY2VfbWU=,size_16,color_FFFFFF,t_70)
### 3.1 接口的定义基本格式
```java
/*
接口就是多个类的公共规范。
...
## 4. 多态
![在这里插入图片描述](https://img-blog.csdnimg.cn/20210123161335476.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NsaWVuY2VfbWU=,size_16,color_FFFFFF,t_70)
### 4.1 多态的格式和使用
...
```
### 4.3 使用多态的好处
![在这里插入图片描述](https://img-blog.csdnimg.cn/20210123163741345.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NsaWVuY2VfbWU=,size_16,color_FFFFFF,t_70)
### 4.4 对象的向上转型
![在这里插入图片描述](https://img-blog.csdnimg.cn/20210123164644257.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NsaWVuY2VfbWU=,size_16,color_FFFFFF,t_70)
...
### 4.7 笔记本USB案例
![在这里插入图片描述](https://img-blog.csdnimg.cn/20210123170628858.png)

![在这里插入图片描述](https://img-blog.csdnimg.cn/20210123170255475.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NsaWVuY2VfbWU=,size_16,color_FFFFFF,t_70)
