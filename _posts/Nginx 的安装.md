...
![在这里插入图片描述](https://img-blog.csdnimg.cn/img_convert/7c4cfa49847d7ffb65fc8960e7899f0c.png)
### 3、安装依赖包
1. `PCRE库`
...
```
可以查到两个进程
![在这里插入图片描述](https://img-blog.csdnimg.cn/img_convert/d71234225c7171866fa394ce4cb1e5f5.png)
通过公网ip即可进入一下界面：
显示以下界面，说明成功
![在这里插入图片描述](https://img-blog.csdnimg.cn/img_convert/491329501a9003f82cea19561a713293.png)
