...
- [原型模式](/notes/backend/design-pattern#_4-原型模式)

:::

::: info 结构型模式：

- [适配器模式](/notes/backend/design-pattern#_5-适配器模式)
- [代理模式](/notes/backend/design-pattern#_6-代理模式)
- [装饰模式](/notes/backend/design-pattern#_7-装饰模式)
- [外观模式](/notes/backend/design-pattern#_8-外观模式)
- [桥接模式](/notes/backend/design-pattern#_9-桥接模式)
- [组合模式](/notes/backend/design-pattern#_10-组合模式)
- [享元模式](/notes/backend/design-pattern#_11-享元模式)

:::

::: info 行为型模式：

- [观察者模式](/notes/backend/design-pattern#_12-观察者模式)
- [策略模式](/notes/backend/design-pattern#_13-策略模式)
- [命令模式](/notes/backend/design-pattern#_14-命令模式)
- [中介者模式](/notes/backend/design-pattern#_15-中介者模式)
- [备忘录模式](/notes/backend/design-pattern#_16-备忘录模式)
- [模板方法模式](/notes/backend/design-pattern#_17-模板方法模式)
- [迭代器模式](/notes/backend/design-pattern#_18-迭代器模式)
- [状态模式](/notes/backend/design-pattern#_19-状态模式)
- [责任链模式](/notes/backend/design-pattern#_20-责任链模式)
- [解释器模式](/notes/backend/design-pattern#_21-解释器模式)
- [访问者模式](/notes/backend/design-pattern#_22-访问者模式)
